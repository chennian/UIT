...
class MyWordsController:SNBaseViewController {
    ...
    let noticeDes = UILabel().then{
        ...
        $0.text = "助记词用于恢复钱包或重置钱包密码，将他准确的抄写到纸上，并存放在的只有你知道的地方"
        $0.font = Font(26)
        $0.numberOfLines = 0
    }
...
extension MyWordsController {
    ...
    override func setupView() {
        ...
        self.contentLable.text = self.word
