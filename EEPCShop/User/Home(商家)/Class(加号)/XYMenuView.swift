...
private let kXYMenuContentBackColor = ColorRGBA(red: 59.0, green: 59.0, blue: 59.0, alpha: 1)
private let kXYMenuContentLineColor = UIColor(white: 0.7, alpha: 0.4)
        ...
        for i in 0 ..< Int(count)  {
            ...
            if isDown {
                ...
                if i != 0 {
                    ...
                    lineLayer.frame = CGRect(x: (kContentItemHeight / 3) + 25, y: Double(i) * kContentItemHeight + kTriangleHeight - 1, width: menuContentWidth - (kContentItemHeight) * 2.0 / 3.0 - 8  , height: 0.5)
